...
# Launcher script
cp "$ROOT/scripts/app/cyberdart-browser" "$APP_DIR/Contents/MacOS/cyberdart-browser"
chmod +x "$APP_DIR/Contents/MacOS/cyberdart-browser"
...
<dict>
  ...
  <string>cyberdart-browser</string>
...
echo "    Contents/MacOS/cyberdart-browser     (launcher)"
