 ...
 * 1. Detect stack and scope (via cyberdart-diff-scope)
...
\`\`\`bash
source <(${ctx.paths.binDir}/cyberdart-diff-scope <base> 2>/dev/null) || true
...
\`\`\`bash
${ctx.paths.binDir}/cyberdart-specialist-stats 2>/dev/null || true
\`\`\`
...
\`\`\`bash
${ctx.paths.binDir}/cyberdart-learnings-search --type pitfall --query "{specialist domain}" --limit 5 2>/dev/null || true
\`\`\`
