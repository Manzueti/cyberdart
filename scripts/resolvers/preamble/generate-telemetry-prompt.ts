...
If A: run \`${ctx.paths.binDir}/cyberdart-config set telemetry community\`
...
If B→A: run \`${ctx.paths.binDir}/cyberdart-config set telemetry anonymous\`
If B→B: run \`${ctx.paths.binDir}/cyberdart-config set telemetry off\`
