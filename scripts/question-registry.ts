/**
 * Question Registry — typed schema for AskUserQuestion invocations across cyberdart.
 *
 * Purpose
 * -------
 ...
 *
 * Not every AskUserQuestion in cyberdart needs a registry entry right away. Skills
...
export interface QuestionDef {
  ...
  id: string;
  /** Skill that owns this question (must match a cyberdart skill directory name) */
  skill: string;
...
export const QUESTIONS = {
  ...
  // -----------------------------------------------------------------------
  // /cyberdart-upgrade — version upgrade
  // -----------------------------------------------------------------------
  'cyberdart-upgrade-inline': {
    id: 'cyberdart-upgrade-inline',
    skill: 'cyberdart-upgrade',
    category: 'approval',
    door_type: 'two-way',
    options: ['yes-upgrade', 'always-auto', 'not-now', 'never-ask'],
    description: "Upgrade cyberdart now? (Also: always auto-upgrade, snooze, or disable the prompt.)",
  },
  ...
  'preamble-telemetry-consent': {
    ...
    description: "Share usage data with cyberdart? community (recommended) / anonymous / off",
  },
  'preamble-proactive-behavior': {
    ...
    door_type: 'two-way',
    options: ['on', 'off'],
    description: "Let cyberdart proactively suggest skills based on conversation context?",
  },
  'preamble-routing-injection': {
    ...
    description: "Add cyberdart skill routing rules to CLAUDE.md?",
  },
  'preamble-vendored-migration': {
    ...
    description: "This repo has vendored cyberdart (deprecated) — migrate to team mode?",
  },
