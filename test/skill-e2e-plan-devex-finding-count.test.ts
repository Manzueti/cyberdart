...
const PLAN_DEVEX_5_FINDINGS = [
  'Please review this plan thoroughly. As you go, write your plan-mode plan to /tmp/cyberdart-test-plan-devex.md (use Edit/Write to that exact path).',
  '',
...
const PLAN_DEVEX_PATH = '/tmp/cyberdart-test-plan-devex.md';
