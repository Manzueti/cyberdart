...
const PLAN_DESIGN_5_FINDINGS = [
  'Please review this plan thoroughly. As you go, write your plan-mode plan to /tmp/cyberdart-test-plan-design.md (use Edit/Write to that exact path).',
  '',
...
const PLAN_DESIGN_PATH = '/tmp/cyberdart-test-plan-design.md';
