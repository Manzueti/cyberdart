/**
 * cyberdart-gbrain-repo-policy — per-remote trust-tier policy store.
 *
 ...
 *
 * Each test uses a temp CYBERDART_HOME so nothing leaks into the user's real ~/.cyberdart.
 */
...
const BIN = path.join(ROOT, 'bin', 'cyberdart-gbrain-repo-policy');
