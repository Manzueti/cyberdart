...
- Save the report to .cyberdart/security-reports/.`,
    ...
    const reportDir = path.join(csoDir, '.cyberdart', 'security-reports');
...
- Skip the preamble (cyberdart-update-check, telemetry, etc.) — go straight to the audit.
