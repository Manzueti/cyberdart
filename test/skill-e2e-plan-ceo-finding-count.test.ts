 ...
 * for our seeded fixture (the agent would review the cyberdart PR itself,
...
const PLAN_CEO_5_FINDINGS = [
  'Please review this plan thoroughly. As you go, write your plan-mode plan to /tmp/cyberdart-test-plan-ceo.md (use Edit/Write to that exact path).',
  '',
...
const PLAN_CEO_2_PAIRED_FINDINGS = [
  'Please review this plan thoroughly. As you go, write your plan-mode plan to /tmp/cyberdart-test-plan-ceo-paired.md (use Edit/Write to that exact path).',
  '',
...
const PLAN_CEO_PATH = '/tmp/cyberdart-test-plan-ceo.md';
const PLAN_CEO_PAIRED_PATH = '/tmp/cyberdart-test-plan-ceo-paired.md';
