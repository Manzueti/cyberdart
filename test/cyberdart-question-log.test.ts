/**
 * bin/cyberdart-question-log — schema validation + injection defense tests.
 */
...
const BIN = path.join(ROOT, 'bin', 'cyberdart-question-log');
...
describe('cyberdart-question-log — valid payloads', () => {
...
describe('cyberdart-question-log — rejected payloads', () => {
...
describe('cyberdart-question-log — injection defense', () => {
  const attacks = [
