/**
 * cyberdart-model-benchmark CLI tests (offline).
 *
...
const BIN = path.join(ROOT, 'bin', 'cyberdart-model-benchmark');
...
describe('cyberdart-model-benchmark prompt resolution', () => {
