/**
 * Tests for bin/cyberdart-diff-scope — verifies scope signal detection.
 *
...
const SCRIPT = join(import.meta.dir, '..', 'bin', 'cyberdart-diff-scope');
