...
const PLAN_ENG_5_FINDINGS = [
  'Please review this plan thoroughly. As you go, write your plan-mode plan to /tmp/cyberdart-test-plan-eng.md (use Edit/Write to that exact path).',
  '',
...
const PLAN_ENG_PATH = '/tmp/cyberdart-test-plan-eng.md';
