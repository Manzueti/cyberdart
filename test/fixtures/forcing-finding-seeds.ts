...
export const FORCING_FLOOR_ENG = [
  'Please review this plan thoroughly. As you go, write your plan-mode plan to /tmp/cyberdart-test-plan-eng-floor.md (use Edit/Write to that exact path).',
  '',
...
export const FORCING_FLOOR_CEO = [
  'Please review this plan thoroughly. As you go, write your plan-mode plan to /tmp/cyberdart-test-plan-ceo-floor.md (use Edit/Write to that exact path).',
  '',
...
export const FORCING_FLOOR_DESIGN = [
  'Please review this plan thoroughly. As you go, write your plan-mode plan to /tmp/cyberdart-test-plan-design-floor.md (use Edit/Write to that exact path).',
  '',
...
export const FORCING_FLOOR_DEVEX = [
  'Please review this plan thoroughly. As you go, write your plan-mode plan to /tmp/cyberdart-test-plan-devex-floor.md (use Edit/Write to that exact path).',
  '',
...
export const FORCING_BATCHING_ENG = [
  'Please review this plan thoroughly. As you go, write your plan-mode plan to /tmp/cyberdart-test-plan-eng-batching.md (use Edit/Write to that exact path).',
  '',
