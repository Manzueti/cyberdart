...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  'operational-learning':     ['scripts/resolvers/preamble.ts', 'bin/cyberdart-learnings-log'],
  ...
  'review-army-migration-safety': ['review/**', 'scripts/resolvers/review-army.ts', 'bin/cyberdart-diff-scope'],
  'review-army-perf-n-plus-one':  ['review/**', 'scripts/resolvers/review-army.ts', 'bin/cyberdart-diff-scope'],
  ...
  'auto-decide-preserved':        ['scripts/resolvers/question-tuning.ts', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/preamble/generate-completion-status.ts', 'plan-ceo-review/**', 'bin/cyberdart-question-preference', 'bin/cyberdart-config', 'bin/cyberdart-slug', 'test/helpers/claude-pty-runner.ts'],
  ...
  'ship-idempotency-pty':        ['ship/**', 'bin/cyberdart-next-version', 'lib/worktree.ts', 'test/helpers/claude-pty-runner.ts'],
  ...
  'brain-privacy-gate':           ['scripts/resolvers/preamble/generate-brain-sync-block.ts', 'scripts/resolvers/preamble.ts', 'bin/cyberdart-brain-sync', 'bin/cyberdart-artifacts-init', 'bin/cyberdart-config', 'test/helpers/agent-sdk-runner.ts'],
  ...
  'setup-gbrain-remote':          ['setup-gbrain/SKILL.md.tmpl', 'bin/cyberdart-gbrain-mcp-verify', 'bin/cyberdart-artifacts-init', 'bin/cyberdart-gbrain-detect', 'test/helpers/agent-sdk-runner.ts'],
  'setup-gbrain-bad-token':       ['setup-gbrain/SKILL.md.tmpl', 'bin/cyberdart-gbrain-mcp-verify', 'test/helpers/agent-sdk-runner.ts'],
  ...
  'plan-tune-inspect':         ['plan-tune/**', 'scripts/question-registry.ts', 'scripts/psychographic-signals.ts', 'scripts/one-way-doors.ts', 'bin/cyberdart-question-log', 'bin/cyberdart-question-preference', 'bin/cyberdart-developer-profile'],
  ...
  // Ship
  'ship-base-branch': ['ship/**', 'bin/cyberdart-repo-mode'],
  ...
  // Global discover
  'global-discover':   ['bin/cyberdart-global-discover.ts', 'test/global-discover.test.ts'],
  ...
  // Learnings
  'learnings-show': ['learn/**', 'bin/cyberdart-learnings-search', 'bin/cyberdart-learnings-log', 'scripts/resolvers/learnings.ts'],

  // Session Intelligence (timeline, context recovery, /context-save + /context-restore)
  'timeline-event-flow':            ['bin/cyberdart-timeline-log', 'bin/cyberdart-timeline-read'],
  'context-recovery-artifacts':     ['scripts/resolvers/preamble.ts', 'bin/cyberdart-timeline-log', 'bin/cyberdart-slug', 'learn/**'],
  'context-save-writes-file':       ['context-save/**', 'bin/cyberdart-slug'],
  'context-restore-loads-latest':   ['context-restore/**', 'bin/cyberdart-slug'],
  ...
  'context-save-then-restore-roundtrip':   ['context-save/**', 'context-restore/**', 'bin/cyberdart-slug'],
  ...
  'codex-review-findings': ['review/**', '.agents/skills/cyberdart-review/**', 'codex/**', 'test/helpers/codex-session-runner.ts', 'lib/worktree.ts'],
  ...
  'ship-coverage-audit': ['ship/**', 'test/fixtures/coverage-audit-fixture.ts', 'bin/cyberdart-repo-mode'],
  ...
  'ship-triage': ['ship/**', 'bin/cyberdart-repo-mode'],
  ...
  // cyberdart-upgrade
  'cyberdart-upgrade-happy-path': ['cyberdart-upgrade/**'],

  // Deploy skills
  'land-and-deploy-workflow':      ['land-and-deploy/**', 'scripts/gen-skill-docs.ts'],
  'land-and-deploy-first-run':     ['land-and-deploy/**', 'scripts/gen-skill-docs.ts', 'bin/cyberdart-slug'],
  'land-and-deploy-review-gate':   ['land-and-deploy/**', 'bin/cyberdart-review-read'],
  ...
  'autoplan-dual-voice': ['autoplan/**', 'codex/**', 'bin/cyberdart-codex-probe', 'scripts/resolvers/review.ts', 'scripts/resolvers/design.ts'],

  // Multi-provider benchmark adapters — live API smoke against real claude/codex/gemini CLIs
  'benchmark-providers-live': ['bin/cyberdart-model-benchmark', 'test/helpers/providers/**', 'test/helpers/benchmark-runner.ts', 'test/helpers/pricing.ts'],
...
export const E2E_TIERS: Record<string, 'gate' | 'periodic'> = {
  ...
  // Privacy gate for cyberdart-brain-sync — periodic (non-deterministic LLM call,
  ...
  // cyberdart-upgrade
  'cyberdart-upgrade-happy-path': 'gate',
...
export const LLM_JUDGE_TOUCHFILES: Record<string, string[]> = {
  ...
  'cyberdart-upgrade/SKILL.md upgrade flow': ['cyberdart-upgrade/SKILL.md', 'cyberdart-upgrade/SKILL.md.tmpl'],
