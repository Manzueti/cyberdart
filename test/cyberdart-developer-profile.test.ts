/**
 * bin/cyberdart-developer-profile — subcommand behavior tests.
 *
 * Covers:
...
const BIN_DEV = path.join(ROOT, 'bin', 'cyberdart-developer-profile');
const BIN_LOG = path.join(ROOT, 'bin', 'cyberdart-question-log');

let tmpHome: string;

beforeEach(() => {
  tmpHome = fs.mkdtempSync(path.join(os.tmpdir(), 'cyberdart-test-'));
});
...
describe('cyberdart-developer-profile --read', () => {
...
describe('cyberdart-developer-profile --migrate', () => {
...
describe('cyberdart-developer-profile tier calculation', () => {
...
describe('cyberdart-developer-profile --derive', () => {
...
describe('cyberdart-developer-profile --trace <dim>', () => {
...
describe('cyberdart-developer-profile --gap', () => {
...
describe('cyberdart-developer-profile --vibe', () => {
...
describe('cyberdart-developer-profile --check-mismatch', () => {
...
describe('cyberdart-developer-profile errors', () => {
