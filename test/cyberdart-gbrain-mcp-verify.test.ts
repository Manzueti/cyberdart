/**
 * cyberdart-gbrain-mcp-verify — error-classification tests with a mocked curl.
 *
...
const VERIFY_BIN = path.join(ROOT, 'bin', 'cyberdart-gbrain-mcp-verify');
...
beforeEach(() => {
  tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), 'cyberdart-mcp-verify-test-'));
...
describe('cyberdart-gbrain-mcp-verify', () => {
