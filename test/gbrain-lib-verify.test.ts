/**
 * cyberdart-gbrain-supabase-verify + cyberdart-gbrain-lib.sh — Slice 3 of /setup-gbrain.
 *
 ...
 * skill template and by cyberdart-gbrain-supabase-provision. Validates var
...
const VERIFY = path.join(ROOT, 'bin', 'cyberdart-gbrain-supabase-verify');
...
describe('cyberdart-gbrain-supabase-verify', () => {
  const VALID =
...
describe('cyberdart-gbrain-lib.sh read_secret_to_env', () => {
