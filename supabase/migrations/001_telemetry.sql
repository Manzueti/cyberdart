...
CREATE TABLE telemetry_events (
  ...
  cyberdart_version TEXT NOT NULL,
  os TEXT NOT NULL,
  arch TEXT,
...
CREATE INDEX idx_telemetry_error ON telemetry_events (error_class, cyberdart_version) WHERE outcome = 'error';
...
GROUP BY error_class, cyberdart_version
