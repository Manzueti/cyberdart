#!/usr/bin/env bash
# Supabase project config for cyberdart telemetry
...
CYBERDART_SUPABASE_URL="https://frugpmstpnojnhfyimgv.supabase.co"
CYBERDART_SUPABASE_ANON_KEY="sb_publishable_tR4i6cyMIrYTE3s6OyHGHw_ppx2p6WK"
