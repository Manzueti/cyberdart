/**
 * cyberdart browse — CSS Inspector content script
 *
...
(() => {
  ...
  if (window.__cyberdartInspectorActive) return;
  window.__cyberdartInspectorActive = true;
  ...
  function createHighlight() {
    ...
    highlightEl.id = 'cyberdart-inspector-highlight';
    ...
    tooltipEl.id = 'cyberdart-inspector-tooltip';
  ...
  function onMouseMove(e) {
    ...
    if (target.id === 'cyberdart-inspector-highlight' || target.id === 'cyberdart-inspector-tooltip') return;
  ...
  function injectCSS(id, css) {
    ...
    const styleId = `cyberdart-inject-${id}`;
