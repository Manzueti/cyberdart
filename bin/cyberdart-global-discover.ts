#!/usr/bin/env bun
/**
 * cyberdart-global-discover — Discover AI coding sessions across Claude Code, Codex CLI, and Gemini CLI.
 ...
 *
 * Usage:
 *   cyberdart-global-discover --since 7d [--format json|summary]
 *   cyberdart-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: cyberdart-global-discover --since <window> [--format json|summary]
...
Examples:
  cyberdart-global-discover --since 7d
  cyberdart-global-discover --since 14d --format summary`);
}
