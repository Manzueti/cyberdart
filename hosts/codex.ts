...
const codex: HostConfig = {
  ...
  globalRoot: '.codex/skills/cyberdart',
  ...
  pathRewrites: [
    { from: '~/.claude/skills/cyberdart', to: '$CYBERDART_ROOT' },
    { from: '.claude/skills/cyberdart', to: '.agents/skills/cyberdart' },
    { from: '.claude/skills/review', to: '.agents/skills/cyberdart/review' },
