...
const factory: HostConfig = {
  ...
  globalRoot: '.factory/skills/cyberdart',
  localSkillRoot: '.factory/skills/cyberdart',
  hostSubdir: '.factory',
  usesEnvVars: true,
  ...
  pathRewrites: [
    ...
    { from: '.claude/skills/cyberdart', to: '.factory/skills/cyberdart' },
    { from: '.claude/skills/review', to: '.factory/skills/cyberdart/review' },
