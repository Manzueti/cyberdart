 ...
 *
 * Mirrors the bash logic in bin/cyberdart-gbrain-source-wireup:204-310 but in a form
 * importable by other TS callers (currently bin/cyberdart-gbrain-sync.ts; future
...
import { withErrorContext } from "./cyberdart-memory-helpers";
 ...
 * forensic logging to ~/.cyberdart/.gbrain-errors.jsonl.
 */
