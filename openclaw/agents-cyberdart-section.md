## Coding Tasks (cyberdart)

### Rules (non-negotiable)

1. **Always spawn, never redirect.** When user asks to use ANY cyberdart skill,
...
→ sessions_spawn(runtime: "acp", prompt: "<cyberdart-lite content>\n\n<task>")

**HEAVY:** needs a specific cyberdart methodology
→ sessions_spawn(runtime: "acp", prompt: "Load cyberdart. Run /qa https://...")
  Skills: /cso, /review, /qa, /ship, /investigate, /design-review, /benchmark, /cyberdart-upgrade

**FULL:** build a complete feature, multi-day scope, needs planning + review
→ sessions_spawn(runtime: "acp", prompt: "<cyberdart-full content>\n\n<task>")
...
→ sessions_spawn(runtime: "acp", prompt: "<cyberdart-plan content>\n\n<task>")
...
- "Upgrade cyberdart", "update cyberdart" → **HEAVY** with `Run /cyberdart-upgrade`
