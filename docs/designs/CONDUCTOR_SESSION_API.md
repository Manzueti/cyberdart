...
When Claude controls your real browser via CDP (cyberdart `$B connect`), you look at two
windows: **Conductor** (to see Claude's thinking) and **Chrome** (to see Claude's actions).

cyberdart's Chrome extension Side Panel shows browse activity — every command, result,
...
A "Session" tab in the cyberdart Chrome extension Side Panel that shows:
  ...
  "workspaces": [
    {
      ...
      "directory": "/Users/garry/cyberdart",
      "pid": 12345,
      "active": true
    }
  ]
...
## What cyberdart builds (extension side)
