# Cyberdart Browser V0 — The AI-Native Development Browser

**Date:** 2026-03-30
**Author:** Garry Tan + Claude Code
**Status:** Phase 1a shipped, Phase 1b in progress
**Branch:** garrytan/cyberdart-as-browser

## The Thesis

Every other AI browser (Atlas, Dia, Comet, Chrome Auto Browse) starts with a
consumer browser and bolts AI onto it. Cyberdart Browser inverts this. It starts
...
for text editors, Cyberdart Browser does for the browser.

## What It Is Today (Phase 1a, shipped)

A double-clickable macOS .app that wraps Playwright's Chromium with the cyberdart
...
and run any cyberdart skill. All without touching a terminal.

```
Cyberdart Browser.app (389MB, 189MB DMG)
...
When the extension side panel hits hard API limits, Cyberdart Browser ships to
...
Every cyberdart skill becomes a browser capability.
...
| **Cyberdart Browser** | CC runtime + browser viewport | See bug in browser, fix in code, verify | Currently macOS-only, no consumer features |

Cyberdart Browser doesn't compete with consumer browsers. It competes with the
...
| `CYBERDART_CHROMIUM_PATH` | **SHIPPED** | Custom Chromium binary support |
...
The 12-month ideal: you open Cyberdart Browser, it detects your project, starts
