# Adding a New Host to cyberdart

cyberdart uses a declarative host config system. Each supported AI coding agent
...
const myhost: HostConfig = {
  ...
  globalRoot: '.myhost/skills/cyberdart',
  localSkillRoot: '.myhost/skills/cyberdart',
  hostSubdir: '.myhost',
  ...
  pathRewrites: [
    { from: '~/.claude/skills/cyberdart', to: '~/.myhost/skills/cyberdart' },
    { from: '.claude/skills/cyberdart', to: '.myhost/skills/cyberdart' },
...
ls .myhost/skills/cyberdart-*/SKILL.md
